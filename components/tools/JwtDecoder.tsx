...
export const JwtDecoder: React.FC = () => {
  ...
  return (
    <ToolWrapper 
      title="JWT Decoder" 
      description="Decode JSON Web Tokens to inspect claims and expiration."
      actions={
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
        ...
        <div className="flex flex-col gap-2 h-full">
           ...
           <textarea
             ...
             className={`flex-1 w-full bg-surfaceHighlight border rounded-md p-4 font-mono text-sm break-all focus:outline-none focus:ring-1 resize-none placeholder:text-zinc-600 ${
                error ? 'border-red-500 focus:border-red-500' : 'border-zinc-700 focus:border-primary'
             }`}
             spellCheck={false}
           />
           {error && (
